...
async function SwitchRegion(play) {
	...
	const TW = $.read('BiliArea_TW') || '🇨🇳 TW-cheap'; //Your Taiwan sub-policy name.
	const HK = $.read('BiliArea_HK') || '🇭🇰 HK-cheap'; //Your HongKong sub-policy name.
	const DF = $.read('BiliArea_DF') || '🇨🇳 TW-cheap'; //Sub-policy name used after region is blocked(e.g. url 404)
